-- Create a teacher profile if one doesn't exist
INSERT INTO profiles (user_id, email, full_name, role) 
VALUES (gen_random_uuid(), 'teacher@example.com', 'John Teacher', 'teacher')
ON CONFLICT (user_id) DO NOTHING;

-- Create sample assignments with the teacher as creator
